  ...
  [
    ...
    check('festivals').custom((festivals) => {
      ...
      festivals.forEach((festival, index) => {
        ...
        if (!festivalRoles || !Array.isArray(festivalRoles)) {
          throw new Error(
            `Festival roles at index ${index} must be an array (e.g., []).`,
          )
        }
        ...
        festivalRoles.forEach((role, roleIndex) => {
          ...
          if (
            ...
            throw new Error(
              `Festival role name at index ${roleIndex} (in festival ${index}) must be between 6 and 40 characters`,
            )
          }
          ...
          if (
            ...
            throw new Error(
              `Festival person name at index ${roleIndex} (in festival ${index}) must be between 6 and 40 characters`,
            )
          }
        })
      })
