...
require("dotenv").config(); // Define the films to seed
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          mongoose.connect("mongodb+srv://".concat(process.env.MONGO_USER, ":").concat(process.env.MONGO_PASSWORD, "@fabrique-db.mfubcus.mongodb.net/").concat(process.env.MONGO_DEFAULT_DATABASE), {
            useNewUrlParser: true,
            useUnifiedTopology: true
          }); // Drop the existing films collection

          _context.next = 4;
          return regeneratorRuntime.awrap(Film.collection.drop());

        case 4:
          _context.next = 6;
          return regeneratorRuntime.awrap(Film.insertMany(films));
